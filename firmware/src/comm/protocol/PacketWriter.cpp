...
bool PacketWriter::write(HardwareSerial &serial, uint8_t type, uint8_t flags,
	...
	return writeRaw(serial, hdr, payload, payload_len);
}

bool PacketWriter::writeRaw(HardwareSerial &serial, const Header &hdr,
	...
	serial.write(cobs_buf, encoded_len);
